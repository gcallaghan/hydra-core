  ...
  this.init = function () {
    ...
    return Promise.all([
      ...
      .then(function () {
        ...
        self.findClass = _.find.bind(null, self.classes, _.property('@id'));
        ...
        self.findOperation = _.find.bind(null, self.operations, _.property('@id'));
  ...
  this.init = function () {
    return Promise.resolve()
      .then(function () {
        ...
        self.findProperty = _.find.bind(null, self.properties, _.property('@id'));
...
hydra.ClassDocument = function (document, abstract, def) {
  ...
  this.findProperty = _.find.bind(null, this.properties, _.property('@id'));
};
